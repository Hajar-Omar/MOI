...
(function (root, window, document, factory, undefined) {
    ...
    function initialise(containerSelector, options) {
        ...
        */
        ...
        document.addEventListener('wheel', ScrollMouseWheel);
        document.addEventListener('mousewheel', ScrollMouseWheel);
        document.addEventListener('DOMMouseScroll', ScrollMouseWheel);
        }
        else{}
        /******** END EDITED */
