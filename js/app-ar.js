...
//     document.querySelector('.fp-slidesNav.fp-bottom li:first-child a').click()
//   });
...
$(document).ready(function () {
    ...
    if ($("#fullpage").length > 0) {
        ...
        var navTooltip = ['الرئيسية', 'الخدمات', 'NEWS & EVENTS', 'المواقع', 'SOCIAL MEDIA', 'إتصل بنا'];
    ...
    if ($(".search_txt").length > 0) {
        var placeholderText = [
            "أريد أن أبحث عن...", "أنواع الخدمات؟", "عدد الخدمات..."
        ];
    ...
    $('.toanimate[data-animate="fadeInRight"]').data("animate", "fadeInLeft");
    ...
    function blurBody() {
        ...
        //    $('#fullpage, header').toggleClass("blur4");
        //}
        $('#fp-nav *,.fp-tableCell, header, .top-content, .main-contnr, footer, .chatbot.inner').toggleClass("blur4");
    }
