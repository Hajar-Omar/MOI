jQuery(function ($) {
	...
	circlesCarousel.fCarousel({
		...
		'onChange': function (carousel) {
			...
			centerItemCir.css({ 'left': '40%' });
			prevItemCir.css({ 'left': '25%' });
			secondPrev.css({ 'left': '-15%' });
			nextItemCir.css({ 'left': '25%' });
			secondNext.css({ 'left': '-15%' });
	...
	centerItem.css({ 'left': '40%' });
	centerItem.prev().css({ 'left': '25%' });
	centerItem.prev().prev().css({ 'left': '-15%' });
	centerItem.next().css({ 'left': '25%' });
	centerItem.next().next().css({ 'left': '-15%' });
